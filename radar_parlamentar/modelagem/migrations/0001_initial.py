...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modelagem_indexadores', (
            ...
            ('termo', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ...
        db.create_table('modelagem_partido', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('numero', self.gf('django.db.models.fields.IntegerField')()),
            ('cor', self.gf('django.db.models.fields.CharField')(max_length=7)),
        ))
        ...
        db.create_table('modelagem_casalegislativa', (
            ...
            ('nome_curto', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('esfera', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('local', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('atualizacao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        ...
        db.create_table('modelagem_parlamentar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_parlamentar', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.create_table('modelagem_legislatura', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parlamentar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.Parlamentar'])),
            ('casa_legislativa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.CasaLegislativa'], null=True)),
            ...
            ('localidade', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        ...
        db.create_table('modelagem_proposicao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_prop', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ...
            ('ano', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('ementa', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('descricao', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('indexacao', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('data_apresentacao', self.gf('django.db.models.fields.DateField')(null=True)),
            ('situacao', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('casa_legislativa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.CasaLegislativa'], null=True)),
            ('autor_principal', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        ...
        db.create_table(m2m_table_name, (
            ...
            ('proposicao', models.ForeignKey(orm['modelagem.proposicao'], null=False)),
            ('parlamentar', models.ForeignKey(orm['modelagem.parlamentar'], null=False))
        ))
        ...
        db.create_table('modelagem_votacao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_vot', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('descricao', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('data', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('resultado', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('proposicao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.Proposicao'], null=True)),
        ))
        ...
        db.create_table('modelagem_voto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('votacao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.Votacao'])),
            ('legislatura', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.Legislatura'])),
            ('opcao', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
