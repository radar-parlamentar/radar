...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('modelagem_voto', 'parlamentar',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['modelagem.Parlamentar']),
                      keep_default=False)

        # Adding field 'Parlamentar.casa_legislativa'
        db.add_column('modelagem_parlamentar', 'casa_legislativa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelagem.CasaLegislativa'], null=True),
                      keep_default=False)

        # Adding field 'Parlamentar.partido'
        db.add_column('modelagem_parlamentar', 'partido',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['modelagem.Partido']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('modelagem_voto', 'legislatura',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['modelagem.Legislatura']),
                      keep_default=False)
