...
Classes:
    ImportadorConvencao gera dados para casa legislativa fictícia chamada Convenção Nacional Francesa
"""
...
class ImportadorConvencao:
    ...
    def _gera_votacao1(self):
        ...
        votacao = self._gera_votacao(NUM, DESCRICAO, DATA_NO_PRIMEIRO_SEMESTRE, prop)
