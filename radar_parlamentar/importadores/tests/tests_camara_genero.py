...
class CamaraTest(TestCase):
    ...
    def test_multiple_null_remove(self):
        ...
        self.assertEqual(multiple_null_remove(lista_proposicoes_null), [{"Casa":1}, {"Educacao":None}, {"Transporte":None}])
        self.assertEqual(multiple_null_remove(lista_proposicoes), [{"Casa:":1, "Lar":2}])
    ...
    def test_proposicoes_indexadas_partido_lista(self):
    	...
    	self.assertEqual(proposicoes_indexadas(lista_proposicoes_partido), indexados_partido)
    ...
    def test_parseia_indexacoes(self):
        ...
        self.assertEqual(parseia_indexacoes(indexacao), ['testeradarparlamentar', 'radarparlamentar'])
